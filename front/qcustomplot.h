...
class QCP_LIB_DECL QCPAxis : public QCPLayerable {
  ...
  Q_PROPERTY(
      SelectableParts selectedParts READ selectedParts WRITE setSelectedParts NOTIFY
          selectionChanged)
  Q_PROPERTY(
      SelectableParts selectableParts READ selectableParts WRITE setSelectableParts NOTIFY
          selectableChanged)
...
class QCP_LIB_DECL QCPAbstractPlottable : public QCPLayerable {
  ...
  Q_PROPERTY(
      QCP::SelectionType selectable READ selectable WRITE setSelectable NOTIFY
          selectableChanged)
  Q_PROPERTY(QCPDataSelection selection READ selection WRITE setSelection NOTIFY
                 selectionChanged)
  Q_PROPERTY(
      QCPSelectionDecorator *selectionDecorator READ selectionDecorator WRITE
...
class QCP_LIB_DECL QCustomPlot : public QWidget {
  ...
  Q_PROPERTY(
      Qt::AspectRatioMode backgroundScaledMode READ backgroundScaledMode WRITE
  ...
  Q_PROPERTY(
      Qt::KeyboardModifier multiSelectModifier READ multiSelectModifier WRITE
...
class QCP_LIB_DECL QCPColorScale : public QCPLayoutElement {
  ...
  Q_PROPERTY(
      QCPAxis::
          ScaleType dataScaleType READ dataScaleType WRITE setDataScaleType NOTIFY
...
class QCP_LIB_DECL QCPErrorBars : public QCPAbstractPlottable,
  ...
  Q_PROPERTY(QCPAbstractPlottable
                 *dataPlottable READ dataPlottable WRITE setDataPlottable)
